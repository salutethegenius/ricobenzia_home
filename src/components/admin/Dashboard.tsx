...
const specialSections = [
  { id: 'events', name: 'Events', icon: '📅', description: 'Manage calendar events', path: '/admin/events' },
];
  ...
  return (
    <div className="min-h-screen bg-space-dark p-4">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Special Sections */}
        <div className="mb-8">
          <h2 className="text-xl font-bold text-clean-white mb-4" style={{ fontFamily: 'Orbitron, sans-serif' }}>
            Quick Actions
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {sections.map((section, index) => (
              <motion.div
                ...
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: (specialSections.length + index) * 0.1 }}
                whileHover={{ scale: 1.02 }}
