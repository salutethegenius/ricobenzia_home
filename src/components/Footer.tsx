    ...
    <footer className="bg-space-dark py-12 border-t border-vibrant-green/10">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="border-t border-vibrant-green/10 pt-8 mb-8">
          <div className="bg-cosmic-purple/20 rounded-xl p-6 border border-cosmic-purple/30">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          ...
          <div className="flex items-center gap-4">
            <motion.a
              href="#"
              whileHover={{ scale: 1.1, color: '#7CFC00' }}
              className="text-clean-white/40 hover:text-vibrant-green transition-colors"
            >
